  ...
  return (
    <div className={cn("relative z-10", className)}>
      <header className="rise-in px-5 pt-5 md:px-8 md:pt-7">
        <div className="mx-auto flex max-w-7xl flex-col gap-2.5 rounded-[26px] border border-white/42 bg-white/42 px-4 py-3 shadow-[0_14px_38px_rgba(21,43,74,0.08),inset_0_1px_0_rgba(255,255,255,0.72)] backdrop-blur-lg backdrop-saturate-125 md:flex-row md:items-center md:justify-between md:gap-0 md:rounded-full md:px-6">
          ...
          <nav className="flex w-full items-center gap-1 overflow-x-auto rounded-full border border-white/28 bg-white/18 p-1 shadow-[inset_0_1px_0_rgba(255,255,255,0.42)] [-webkit-overflow-scrolling:touch] scrollbar-none sm:gap-2 md:w-auto md:overflow-visible">
            {[
              { href: "/", label: "首页" },
